package org.demis27.cbc.person;
...
import org.demis27.cbc.ComicbookConfiguration;
import org.demis27.cbc.domain.Person;
...
@Singleton public class PersonRepository {
    ...
    public Single<Person> update(Person Person) {
        return Single.fromPublisher(getCollection().replaceOne(Filters.eq("_id", Person.getId()), Person))
                .map(success -> Person);
    }
